...
def downgrade():
    with op.batch_alter_table('hospitalization_diary_entries', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_hospitalization_diary_entries_author_id'))
        batch_op.drop_index(batch_op.f('ix_hospitalization_diary_entries_hospitalization_id'))
